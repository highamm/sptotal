---
title: "Using the sptotal Package -- Weighted Sums from Finite Spatial Populations"
author:
...
output:
  prettydoc::html_pretty:
    theme: architect
vignette: >
  %\VignetteIndexEntry{Using the sptotal Package -- Weighted Sums from Finite Spatial Populations}
...
$$  
where $d_{i,j}$ is Euclidean distance between locations $i$ and $j$.  In geostatistics terminology, this model has a partial sill of 2, and a range of 1.  The random errors $\{\varepsilon_i\}$ are independent with variance 0.02, and this variance is called the nugget effect.

The spatial locations of `simdata` are in a $30 \times 30$ grid uniformly spaced in a box with sides of length 1,
```{r, fig.width = 5, fig.height = 5, fig.align="center", cache = TRUE}
